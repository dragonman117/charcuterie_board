...
Builds the static Astro site in a GitHub Actions workflow and deploys the `dist/` artifact to GitHub Pages, with the base path driven by the deployment environment.
