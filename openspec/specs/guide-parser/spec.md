# Guide Parser Specification

## Purpose

Parses seasonal board Markdown files under `boards/` into a structured, ordered show list the site can render, without ever modifying the source files.
