...
Defines the centralized design token system (colors, radii, fonts, mesh accent) that every component consumes, with dark mode as the default theme and an opt-in light theme that both meet WCAG AA contrast.
